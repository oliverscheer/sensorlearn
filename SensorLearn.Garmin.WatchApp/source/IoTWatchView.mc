...
class IoTWatchView extends WatchUi.View {
    ...
    function initialize() {
    	...
    	url = "https://garmin.servicebus.windows.net/watchdata/messages";
    	
    	//Set up the SAS key for HMAC encryption    	
    	// var mySASKey = Application.Properties.getValue("eHSASKey");
    	// var mySASKey = "NqLHCXO/N3MfWufwGwQLOr6Tcqxqh0rUXG3eIJf0xG4=";
    	
    	var mySASKey = "tyko26N61gvWIKQZdJHxf4jBL8etHdhKuolKI8PJSDU=";
		...
		// var keyName = Application.Properties.getValue("eHSASKeyName");
		var keyName = "connectiqapp";
		
    	sas = "SharedAccessSignature sr=" + Comm.encodeURL(url) + "&sig=" + Comm.encodeURL(myoutput) + "&se=" + keyExpiry + "&skn=" + keyName;
    ...
    function timerCallback() {
    	...
    	var params = {
        	...
        	"accelerationX" => xAccel.toNumber(),
        	"accelerationY" => yAccel.toNumber(),
        	"altitude" => altitude.toFloat(),
        	"cadence" => cadence.toNumber(),
        	"heading" => heading.toFloat(),
        	"magnitudeX" => xMag.toNumber(),
        	"magnitudeY" => yMag.toNumber(),
        	"magnitudeZ" => zMag.toNumber(),
        	...
        	"deviceDateTime" => deviceDateTime.toString()
    	};
	    
	    //set the display field variables
	    field2 = xAccel.toString();
	    field3 = heading.toString();
	    field4 = hR.toString();
	    // field4 = ticks.toString();
	    
        // string ehubNamespaceConnectionString = "Endpoint=sb://garmin.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=NqLHCXO/N3MfWufwGwQLOr6Tcqxqh0rUXG3eIJf0xG4=";
        // string eventHubName = "watchdata";
